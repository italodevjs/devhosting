...
// DevHosting knowledge base (language-neutral)
...
// Language-specific behavior instructions
...
router.post("/", async (req: Request, res: Response) => {
  try {
    ...
    // Use the language sent by the frontend, defaulting to Portuguese
    ...
    const reply = completion.choices[0]?.message?.content || "Sorry, I could not process your message. Please try again.";
